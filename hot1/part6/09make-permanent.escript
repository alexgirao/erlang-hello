...
main(_Args) ->
	...
	_ ->
	    {ok, _OtherVsn, _Descr} = release_handler:install_release("1"),

	    % this will change ROOT/releases/RELEASES and ROOT/releases/start_erl.data

	    ok = release_handler:make_permanent("1")
    end,
